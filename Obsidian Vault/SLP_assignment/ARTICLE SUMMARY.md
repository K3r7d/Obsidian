1. INTRODUCTION: 
- Main idea of this  referrence is using two-stage SLP and interger program (SMIP) to construct the most effiecient plan for evacuating people when the disaster come. 
...
2. PROBLEM STATEMENT:
	1. Representation of the evacuation problem as a two-stage stochastic programming problem:
		-  At the first stage, the initial warning about the disaster to the resident, the government will provide the initial evacution plan before the new information is informed.
		- In the second stage, depend on the initial result or suprising scenarios happen, they have to change the evacuation adaptively.
		- Example: 
	...
	1. Multiple sources and sinks conversion:
